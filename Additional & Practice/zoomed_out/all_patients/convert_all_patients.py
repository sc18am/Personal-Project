...
def create_list():
    with open("all_patients.csv") as csv_file:

        f = open("all_patients.txt", "a")
...
def write_to_csv():
    ...
    with open("all_patients.txt", "r") as infile:
        stripped = (line.strip() for line in infile)
        lines = (line.split(",") for line in stripped if line)
        with open("all_patients_event_log.csv", "w") as outfile:
